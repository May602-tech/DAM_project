          ...
          <div className="max-w-2xl order-2 lg:order-1">
            ...
            >
              <a 
                ...
                className="group flex items-center gap-3 px-12 py-4 bg-slate-900 text-white rounded-xl font-bold hover:bg-indigo-600 hover:shadow-lg hover:shadow-indigo-500/30 transition-all duration-300 text-lg"
              >
                <span>Start with a short test</span>
